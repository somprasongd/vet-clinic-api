...
CREATE TABLE public.t_upload_image (
	id serial NOT NULL,
	image varchar(200) NOT NULL,
	thumbnail varchar(200) NOT NULL,
	thumbnail_small varchar(200) NOT NULL,
	create_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
	CONSTRAINT t_upload_image_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.t_user (
	...
	CONSTRAINT t_user_fk FOREIGN KEY (avatar_id) REFERENCES t_upload_image(id) DEFERRABLE INITIALLY DEFERRED
);
